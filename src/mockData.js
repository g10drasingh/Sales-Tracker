export const mockCategories = [
    ...
    },
    {
        ...
        name: 'Storage (SSD)',
        subcategories: [
            { id: 501, name: 'Brand', details: [{ id: 5011, name: 'Samsung' }, { id: 5012, name: 'Crucial' }, { id: 5012, name: 'Western Digital' }] },
...
const generateMockSales = () => {
    ...
    let saleId = 1;
    for (let i = 0; i < 180; i++) { // Last 6 months (approx. 180 days)
        const date = new Date(today);
        date.setDate(today.getDate() - i);
        const dailySalesCount = Math.floor(Math.random() * 5); // 0-4 sales per day
